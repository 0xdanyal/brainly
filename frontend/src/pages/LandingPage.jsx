...
export default function Landing() {
    return (
        <>
            ...
            {/* FOOTER */}
            <footer style={{ borderTop: '1px solid var(--line)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '24px 40px', maxWidth: 1100, margin: '0 auto', gap: '12px' }}>
                <span style={{ fontFamily: 'IBM Plex Mono, monospace', fontSize: 11, color: '#9b9b9b' }}>
                    © {new Date().getFullYear()} Brainly. Save smarter.
                </span>
                <div style={{ display: 'flex', alignItems: 'center', gap: '16px', fontFamily: 'IBM Plex Mono, monospace', fontSize: 11, color: '#9b9b9b' }}>
                    <span>Created by <strong style={{ color: '#0f0f0f' }}>Danyal</strong></span>
                    <div style={{ display: 'flex', gap: '12px' }}>
                        <a href="https://x.com/0xonchainer" target="_blank" rel="noopener noreferrer" title="X" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: 20, height: 20 }}>
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" style={{ color: '#0f0f0f' }}>
                                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24h-6.6l-5.165-6.75-5.868 6.75h-3.306l7.73-8.835L.424 2.25h6.7l4.67 6.168L17.142 2.25zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                            </svg>
                        </a>
                        <a href="https://www.linkedin.com/in/danyal-dev/" target="_blank" rel="noopener noreferrer" title="LinkedIn" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: 20, height: 20 }}>
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" style={{ color: '#0f0f0f' }}>
                                <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
                            </svg>
                        </a>
                        <a href="https://github.com/0xdanyal" target="_blank" rel="noopener noreferrer" title="GitHub" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: 20, height: 20 }}>
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" style={{ color: '#0f0f0f' }}>
